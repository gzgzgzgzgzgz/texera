...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record3<String, UInteger, String>, IUser {
    ...
    @Override
    public UserRecord values(String value1, UInteger value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public UserRecord(String name, UInteger uid, String password) {
        super(User.USER);
